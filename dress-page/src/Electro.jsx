...
function Electro() {
  ...
  const products = PRODUCTS.electronics;
    ...
    <div className="bg-gray-100 min-h-screen pt-48">
      ...
      <div className="bg-white shadow-sm mb-6">
        <div className="max-w-7xl mx-auto px-4 py-6">
          <h1 className="text-3xl font-bold text-gray-800 mb-2">Electronics</h1>
          <p className="text-gray-600">Shop Latest Gadgets & Devices</p>
        </div>
      </div>
